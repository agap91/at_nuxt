...
export default {
  ...
  jsonld() {
    return {
      ...
      description:
        "Грузоперевозки от АвтоТракКом в Королеве. Быстро и аккуратно доставим ваш груз по Москве, области и всей России. Собственный автопарк. Фиксированные тарифы.",
      name: "Грузоперевозки от АвтоТракКом",
      offers: {
        "@type": "Offer",
  ...
  head() {
    ...
    this.title = "Грузоперевозки от АвтоТракКом";
    metaInfo = {
      title: "Грузоперевозки от АвтоТракКом",
      meta: [
        {
          name: "description",
          content:
        ...
        {
          name: "og:title",
          content: "Грузоперевозки от АвтоТракКом в Королеве"
        },
        {
          name: "og:description",
          content:
